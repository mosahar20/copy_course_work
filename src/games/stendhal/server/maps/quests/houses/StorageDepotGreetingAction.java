...
final class StorageDepotGreetingAction extends StorageRoomChatAction implements ChatAction {
	protected StorageDepotGreetingAction(final String questslot) {
		super(questslot);
	}
	...
	public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		if (StorageRoomUtilities.playerOwnsRoom(player)) {
			reply = " At the cost of "
				+ HouseChatAction.COST_OF_SPARE_KEY
				+ " money you can purchase a spare key for your storage room. Do you want to buy one now?";
