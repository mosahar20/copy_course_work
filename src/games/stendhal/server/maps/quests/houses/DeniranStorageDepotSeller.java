...
final class DeniranStorageDepotSeller extends StorageDepotNPCBase {
	/** Cost to buy house in deniran */
	private static final int COST_ADOS = 1000;

	DeniranStorageDepotSeller(final String name, final String location, final StorageRoomTax storageRoomTax) {
	...
	private void init() {
		...
		add(ConversationStates.ATTENDING,
				Arrays.asList("cost", "storage","room", "buy", "purchase"),
				 ...
				 "The cost of a new storage room in Deniran is "
				 + getCost()
				 ...
				 + "The Deniran houses are numbered from "
				 + "1 to 6",
				 null);
		...
		addJob("Welcome to the Storage Depot. I sell storage rooms for the city of Deniran. Please ask about the #cost if you are interested.");
	...
	protected int getCost() {
		return DeniranStorageDepotSeller.COST_ADOS;
	}
